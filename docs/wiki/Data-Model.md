...
| `listings` | **source**, external_id, title, url, district, rooms, area_m2, rent, listing_type, published_at, fetched_at | `uniq_source_extid(unik)`, `ttl_fetched(TTL)`, `match_type_district_rent` |
