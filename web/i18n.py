...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "sv": {
        ...
        "filters.rent_min_placeholder": "Min hyra (kr)",
        "filters.rent_max_placeholder": "Max hyra (kr)",
        "filters.rooms_min_placeholder": "Min rum",
        "filters.rooms_max_placeholder": "Max rum",
        "filters.area_min_placeholder": "Min yta (m²)",
        "filters.area_max_placeholder": "Max yta (m²)",
        "filters.floor_min_placeholder": "Min våning",
        "filters.floor_max_placeholder": "Max våning",
        "filters.require_balcony": "Balkong krävs",
        "filters.require_kitchen": "Eget kök krävs",
        "filters.adv_toggle": "Fler kriterier",
        ...
        "settings.ap_title": "Ansökningsprofil",
        "settings.ap_hint": "Spara dina uppgifter en gång — klistra in på sekunder vid ansökan.",
        "settings.ap_presentation": "Presentation (om dig)",
        "settings.ap_occupation": "Sysselsättning",
        "settings.ap_income": "Månadsinkomst (kr)",
        "settings.ap_phone": "Telefon",
        "settings.ap_household": "Hushåll",
        "settings.ap_movein": "Önskad inflytt",
        "settings.ap_save": "Spara profil",
        "settings.ap_saved": "Profil sparad",
        "settings.ap_copy": "Kopiera presentation",
        "settings.ap_copied": "Kopierat",
        "settings.ap_err": "Kunde inte spara profilen",
        # admin
    ...
    "en": {
        ...
        "filters.rent_min_placeholder": "Min rent (SEK)",
        "filters.rent_max_placeholder": "Max rent (SEK)",
        "filters.rooms_min_placeholder": "Min rooms",
        "filters.rooms_max_placeholder": "Max rooms",
        "filters.area_min_placeholder": "Min area (m²)",
        "filters.area_max_placeholder": "Max area (m²)",
        "filters.floor_min_placeholder": "Min floor",
        "filters.floor_max_placeholder": "Max floor",
        "filters.require_balcony": "Balcony required",
        "filters.require_kitchen": "Own kitchen required",
        "filters.adv_toggle": "More criteria",
        ...
        "settings.ap_title": "Application profile",
        "settings.ap_hint": "Save your details once — paste them in seconds when you apply.",
        "settings.ap_presentation": "Presentation (about you)",
        "settings.ap_occupation": "Occupation",
        "settings.ap_income": "Monthly income (kr)",
        "settings.ap_phone": "Phone",
        "settings.ap_household": "Household",
        "settings.ap_movein": "Preferred move-in",
        "settings.ap_save": "Save profile",
        "settings.ap_saved": "Profile saved",
        "settings.ap_copy": "Copy presentation",
        "settings.ap_copied": "Copied",
        "settings.ap_err": "Could not save the profile",
        # admin
        "admin.title": "Admin — HQRTM",
        "admin.heading": "Admin",
